...
export default function editBrand(): any {
  ...
  const onSubmit: SubmitHandler<any> = async (data) => {
    ...
    setWaiting(false);
    setButtonHide(true);
    router.push("/home/our-brand");
  };

  const { isLoading: loading }: any = useQuery(["resTestimonail"], async () => {
    const { data } = await request.get(`/home/brand/${currentRoute}`);
    reset(data);
  ...
  return (
    <>
      ...
      <div className="max-w-6xl bg-white p-16">
        <h2 className="text-2xl mb-10 font-bold">Update Brand</h2>
