...
import { homeCounterAdd, homeTestimonialCreate } from "../../../service/home";
import { createServices } from "../../../service/service";
...
export default function addTestimonial(): any {
  ...
  const { isLoading, data, isSuccess, mutate, mutateAsync } = createServices();
