...
export default function Testimonial() {
  ...
  const mutation = useMutation((id) => {
    const data = request.delete(`/home/delete-creative-mind/${id}`);
    toast.success("Delete Successfully");
    return data;
  });

  const { isLoading: loading }: any = useQuery(["resTestimonail"], async () => {
    const { data } = await request.get("/home/creative-minds");
    console.log(data);
    ...
    <>
      ...
      <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
        <div className="sm:flex items-center justify-between">
          ...
          <Link href="/home/creative-minds/add-mind">
                          ...
                          <td className="py-3 px-6 text-center">
                            <div className="flex item-center justify-center">
                              <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                <Link href={`/home/creative-minds/${post.id}`}>
                                  <a href="">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      fill="none"
